...
export interface ApiBooking {
  ...
  facility_id: number | null; facility_name: string; facility_hotline: string | null; field_id: number; field_name: string; sport_type: string; field_capacity: number; location: string; time_slot_id: number;
...
export interface BookingQuote { venue_id: number | null; venue_name: string; field_id: number; field_name: string; sport_type: string; field_type: string; location: string; time_slot_id: number; time_slot_name: string; booking_date: string; start_time: string; end_time: string; price: number; total_amount: number; deposit_amount: number; remaining_amount: number; deposit_type: string; deposit_value: number; hold_minutes: number; free_cancellation_minutes: number; cancellation_policy_summary: string; }
