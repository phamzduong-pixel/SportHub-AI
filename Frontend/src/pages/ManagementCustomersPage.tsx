...
const paymentLabels: Record<string, string> = { unpaid: 'Chưa thanh toán', pending: 'Chờ thanh toán', deposit_pending: 'Chờ cọc', deposit_paid: 'Đã cọc', partial_paid: 'Thanh toán 1 phần', paid: 'Đã thanh toán', refund_pending: 'Chờ hoàn tiền', refunded: 'Đã hoàn tiền', failed: 'Thất bại', cancelled: 'Đã hủy' };
