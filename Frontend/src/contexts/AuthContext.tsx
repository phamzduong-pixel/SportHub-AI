...
import { apiRequest, clearToken, readRefreshToken, readToken, revokeSession, saveRefreshToken, saveToken } from '@/services/apiClient';
...
export const clearUserScopedCache = () => {
  ...
  localStorage.removeItem('sporthub_customer_profile');
  localStorage.removeItem('sporthub_customer_bookings');
  localStorage.removeItem('sporthub_customer_favorites');
  sessionStorage.removeItem('sporthub_latest_booking');
  sessionStorage.removeItem('sporthub_booking_context');
  sessionStorage.removeItem('sporthub_booking_draft');
};
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const logout = useCallback(() => {
    ...
    clearToken(); clearUserScopedCache(); setUser(null);
    window.dispatchEvent(new Event('sporthub-auth-cleared'));
    window.dispatchEvent(new Event('sporthub-auth-updated'));
